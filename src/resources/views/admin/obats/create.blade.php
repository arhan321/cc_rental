...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.obat.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.obats.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_obat') ? 'is-invalid' : '' }}" type="text" name="nama_obat" id="nama_obat" value="{{ old('nama_obat', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('jenis_id') ? 'is-invalid' : '' }}" name="jenis_id" id="jenis_id" required>
                    ...
                    @foreach($jenis as $id => $entry)
                        <option value="{{ $entry->id }}" {{ old('jenis_id') == $entry->id ? 'selected' : '' }}>{{ $entry->name }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('golongan_id') ? 'is-invalid' : '' }}" name="golongan_id" id="golongan_id" required>
                    ...
                    @foreach($golongan as $id => $entry)
                        <option value="{{ $entry->id }}" {{ old('golongan_id') == $entry->id ? 'selected' : '' }}>{{ $entry->name }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kode_obat') ? 'is-invalid' : '' }}" type="text" name="kode_obat" id="kode_obat" value="{{ old('kode_obat', $kodeObatBaru) }}" readonly>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('komposisi') ? 'is-invalid' : '' }}" name="komposisi" id="komposisi">{{ old('komposisi') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('dosis') ? 'is-invalid' : '' }}" name="dosis" id="dosis">{{ old('dosis') }}</textarea>
                @if($errors->has('dosis'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('aturan_pakai') ? 'is-invalid' : '' }}" name="aturan_pakai" id="aturan_pakai">{{ old('aturan_pakai') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_izin_edaar') ? 'is-invalid' : '' }}" type="text" name="nomor_izin_edaar" id="nomor_izin_edaar" value="{{ old('nomor_izin_edaar') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_kadaluarsa') ? 'is-invalid' : '' }}" type="text" name="tanggal_kadaluarsa" id="tanggal_kadaluarsa" value="{{ old('tanggal_kadaluarsa') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('stok') ? 'is-invalid' : '' }}" type="number" name="stok" id="stok" value="{{ old('stok') }}" step="1">
                @if($errors->has('stok'))
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status_label') ? 'is-invalid' : '' }}" name="status_label" id="status_label" required>
                    ...
                    @foreach(App\Models\Obat::STATUS_LABEL_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status_label') == $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
