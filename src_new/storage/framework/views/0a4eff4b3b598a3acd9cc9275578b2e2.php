  ...
  <div class="container px-4">
    <div class="hero-card d-flex flex-column flex-md-row align-items-center justify-content-between gap-4 rounded-4 shadow p-4">
      ...
      <p class="mt-3 mb-2 text-secondary">
        ...
        <a href="<?php echo e(url('/ajukan-kostum')); ?>" class="btn text-white mt-3" style="background-color: #a259ff;"> Ajukan Kostum Custom Sekarang</a>
        <?php endif; ?>
        <?php if(auth()->guard()->guest()): ?>
        <a href="<?php echo e(route('login')); ?>" class="btn text-white mt-3" style="background-color: #a259ff;">
      ...
      <div class="hero-image-wrapper d-flex justify-content-center align-items-end flex-shrink-0" style="max-width: 350px;">
        <img src="<?php echo e(asset('front/assets/her.png')); ?>" alt="cosplayer" class="hero-image w-100" style="object-fit: contain;">
      </div>
        ...
        <div class="row mb-4">
                ...
                <div class="border border-2 rounded-4 p-3 mb-4" style="border-radius: 20px !important;">
                    ...
                    <form method="GET" action="<?php echo e(route('home')); ?>">
                        <div class="form-check custom-radio-purple mb-2">
                            <input class="form-check-input" type="radio" name="filterCategory" id="Semua" value="Semua" <?php echo e(request('filterCategory') == 'Semua' ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="Semua">Semua</label>
                        </div>
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="form-check custom-radio-purple mb-2">
                                <input class="form-check-input" type="radio" name="filterCategory" id="<?php echo e($category->id); ?>" value="<?php echo e($category->id); ?>" <?php echo e(request('filterCategory') == $category->id ? 'checked' : ''); ?>>
            ...
            <div class="col-md-9">
                <div class="d-flex justify-content-between align-items-center mb-3 flex-column flex-md-row gap-3">
                    <div class="text-muted" id="productCount">Menampilkan <strong><?php echo e(count($kostums)); ?></strong> produk</div>
                </div>
                <div class="row g-4" id="productList">
                    <?php $__currentLoopData = $kostums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kostum): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    // Kostum sedang terbooking?
                    $locked = $kostum->status === 'Terbooking';
                ?>
                <div class="col-12 col-sm-6 col-lg-4" 
     data-kostums-id="<?php echo e($kostum->id); ?>"
     data-category="<?php echo e($kostum->category->name); ?>" 
     data-price="<?php echo e($kostum->harga_sewa); ?>" 
     data-size="<?php echo e($kostum->ukuran); ?>" 
     data-status="<?php echo e($locked ? 'booked' : 'available'); ?>">
    <div class="card h-100 shadow-sm">
        <img src="<?php echo e(asset('storage/' . $kostum->image)); ?>" class="card-img-top" alt="<?php echo e($kostum->nama_kostum); ?>">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h6 class="card-title fw-semibold mb-0"><?php echo e($kostum->nama_kostum); ?></h6>
                <span class="badge <?php echo e($kostum->status == 'Tersedia' ? 'bg-purple-available' : 'bg-purple-booked'); ?>">
                    <?php echo e($kostum->status); ?>

                </span>
            </div>
            <p class="mb-1 text-muted small">Kategori: <strong><?php echo e($kostum->category->name); ?></strong></p>
            <p class="card-text small text-muted mb-1 product-size">Ukuran: <?php echo e($kostum->ukuran); ?></p>
            <p class="card-text small text-muted"><?php echo e($kostum->deskripsi); ?></p>
            <div class="d-flex justify-content-between align-items-center">
                <span class="fw-bold text-purple">Rp<?php echo e(number_format($kostum->harga_sewa, 0, ',', '.')); ?></span>
                <button
        class="btn btn-outline-dark btn-sm
               <?php echo e($locked ? 'disabled opacity-50 cursor-not-allowed' : ''); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/frontend/index.blade.php ENDPATH**/ ?>