...
<nav class="navbar navbar-expand-lg shadow-sm sticky-top" style="background-color: #f4f0ff;">
  <div class="container px-3 d-flex justify-content-between align-items-center">
    ...
    <img src="<?php echo e(asset('front/assets/logo.png')); ?>"
    ...
    <div class="collapse navbar-collapse order-lg-0" id="navbarNav">
      <ul class="navbar-nav ms-auto text-center text-lg-start w-100 justify-content-end gap-1 align-items-center">
        ...
        <li class="nav-item">
          <a class="nav-link px-2 py-1 fw-normal small" href="<?php echo e(route('riwayat.custom')); ?>" style="color: #6b21a8;">Pengajuan</a>
        </li>
        <?php endif; ?>
        <?php if(auth()->guard()->check()): ?>
        <li class="nav-item">
          <a class="nav-link px-2 py-1 fw-normal small" href="<?php echo e(route('orders.index')); ?>" style="color: #6b21a8;">Pesanan</a>
        </li>
        <?php endif; ?>
        <?php if(auth()->guard()->check()): ?>
        <li class="nav-item">
          <a class="nav-link px-2 py-1 fw-normal small" href="<?php echo e(route('pengembalian.index')); ?>" style="color: #6b21a8;">Pengembalian</a>
        </li>
        <?php endif; ?>
        <?php if(auth()->guard()->check()): ?>
        <li class="nav-item">
          <a class="nav-link px-2 py-1 fw-normal small" href="<?php echo e(route('frontend.histori')); ?>" style="color: #6b21a8;">History Order</a>
        </li>
        <?php endif; ?>
...
<?php endif; ?>
      ...
      <li class="nav-item w-30 text-center">
        ...
        <?php if(auth()->guard()->guest()): ?>
            <li class="nav-item">
                <a href="<?php echo e(route('login')); ?>" class="but-log btn btn-sm d-flex align-items-center gap-1 px-2 py-1">
    ...
    <div class="row gy-4">
      ...
      <div class="col-md-2">
        ...
        <ul class="list-unstyled small text-white-50">
           <li><a href="<?php echo e(url('/')); ?>" class="text-decoration-none text-white-50">Home</a></li>
    <li><a href="<?php echo e(url('/')); ?>" class="text-decoration-none text-white-50">Product</a></li>
    <?php if(auth()->guard()->check()): ?>
    <li><a href="<?php echo e(route('riwayat.custom')); ?>" class="text-decoration-none text-white-50">Pengajuan</a></li>
    <li><a href="<?php echo e(route('orders.index')); ?>" class="text-decoration-none text-white-50">Pesanan</a></li>
    <li><a href="<?php echo e(route('pengembalian.index')); ?>" class="text-decoration-none text-white-50">Pengembalian</a></li>
    <li><a href="<?php echo e(route('frontend.histori')); ?>" class="text-decoration-none text-white-50">History Order</a></li>
    <?php endif; ?>
        </ul>
      </div>
...
<script src="<?php echo e(asset('front/js/product.js')); ?>?v=<?php echo e(filemtime(public_path('front/js/product.js'))); ?>"></script>
