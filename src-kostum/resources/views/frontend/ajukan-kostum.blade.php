  ...
  <div class="mx-auto" style="max-width: 720px;">
    <div class="card border-0 shadow rounded-4" style="background-color: #f7f3ff;">
      <div class="card-body p-5">
        ...
        <form enctype="multipart/form-data" method="POST" action="{{ route('custom-request.store') }}">
          @csrf
          ...
          <div class="mb-4 d-none" id="upload-template">
            ...
            <div class="mt-3">
              <a href="{{ asset('template-ukuran.pdf') }}" class="btn btn-sm btn-outline-purple rounded-3" download>
