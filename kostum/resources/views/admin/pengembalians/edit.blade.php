...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.pengembalian.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route('admin.pengembalians.update', [$pengembalian->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('order_item_id') ? 'is-invalid' : '' }}" name="order_item_id" id="order_item_id" required>
                    ...
                    @foreach($orderItems as $orderItem)
                        <option value="{{ $orderItem->id }}" {{ old('order_item_id', $pengembalian->order_item_id) == $orderItem->id ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tanggal_kembali') ? 'is-invalid' : '' }}" type="date" name="tanggal_kembali" id="tanggal_kembali" value="{{ old('tanggal_kembali', $pengembalian->tanggal_kembali) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('keterlambatan') ? 'is-invalid' : '' }}" type="number" name="keterlambatan" id="keterlambatan" value="{{ old('keterlambatan', $pengembalian->keterlambatan) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    <option value="Perlu Dikembalikan" {{ old('status', $pengembalian->status) == 'Perlu Dikembalikan' ? 'selected' : '' }}>Perlu Dikembalikan</option>
                    <option value="Sudah Dikembalikan" {{ old('status', $pengembalian->status) == 'Sudah Dikembalikan' ? 'selected' : '' }}>Sudah Dikembalikan</option>
