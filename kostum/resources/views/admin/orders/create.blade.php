    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.orders.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('profile_id') ? 'is-invalid' : '' }}" name="profile_id" id="profile_id" required>
                    ...
                    @foreach($users as $user)
                        <option value="{{ optional($user->profile)->id }}" {{ old('profile_id') == optional($user->profile)->id ? 'selected' : '' }}>
                            {{ $user->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kode_order') ? 'is-invalid' : '' }}" type="text" name="kode_order" id="kode_order" value="{{ old('kode_order', $newOrderCode) }}" readonly>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tanggal_sewa') ? 'is-invalid' : '' }}" type="date" name="tanggal_sewa" id="tanggal_sewa" value="{{ old('tanggal_sewa') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tanggal_dikembalikan') ? 'is-invalid' : '' }}" type="date" name="tanggal_dikembalikan" id="tanggal_dikembalikan" value="{{ old('tanggal_dikembalikan') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    ...
                    <option value="Siap Di Ambil" {{ old('status') == 'Siap Di Ambil' ? 'selected' : '' }}>Siap Di Ambil</option>
